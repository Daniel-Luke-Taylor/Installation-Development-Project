...
public class KinectHandTracking extends PApplet {
...
public void getHand(KJoint left1, KJoint right1, KJoint left2, KJoint right2, boolean multi){
  ...
  public void settings() {  size(1024, 425); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "KinectHandTracking" };
    if (passedArgs != null) {
